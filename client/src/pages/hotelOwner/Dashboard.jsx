...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Dashboard' subTitle='Monitor your room listings, track booings and analyze revenue-all in one plce. Stay updated with real-time insights to ensure smooth operations.' />
