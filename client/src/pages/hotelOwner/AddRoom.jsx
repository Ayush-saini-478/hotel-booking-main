...
const AddRoom = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    if (!inputs.roomType || !inputs.amenities || !inputs.pricePerNight ||
      ...
      <div className='w-full flex  max-sm:flex-col sm:gap-4 mt-4'>
        <div className='flex-1 max-w-48'>
          ...
          <select value={inputs.roomType} onChange={e => setInputs({ ...inputs, roomType: e.target.value })}
            className='border opacity-70 boder-gray-300 mt-1 rounded p-2 w-full'>
        ...
        <div>
          ...
          <input type="number" placeholder='0' className='border borderr-gray-300 mt-1 rounded p-2 w-24' value={inputs.pricePerNight} onChange={e => setInputs({ ...inputs, pricePerNight: e.target.value })} />
        </div>
      </div>
