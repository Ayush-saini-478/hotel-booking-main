...
const ListRoom = () => {
    ...
    return (
        <div>
            <Title align='left' font='outfit' title='Room Listings' subTitle='Vie, edit, or manage all listed rooms. Keeps the information up-to-date to provide the best experience for users.' />
                    ...
                    <tbody className='text-sm'>
                        {
                            rooms.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td className='py-3 px-4 text-red-500 tet-sm text-center border-t border-gray-300 '>
